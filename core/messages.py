...
class module_net_proxy:
    ...
    proxy_set_proxy = 'Set the proxy to tunnel through the target. Visit \'http://evilshell/\' to install the certificate'
...
class module_net_phpproxy:
    ...
    proxy_script_removed = 'The PHP proxy script will be removed at evilshell exit'
...
Run the following commands in another console outside evilshell to mount
...
"""
    httpfs_agent_removed = 'The PHP agent will be removed at evilshell exit'
...
class module_audit_disablefunctionbypass:
    ...
    requests_not_obfuscated = 'Type \'quit\' to return to evilshell shell. Requests are not obfuscated'

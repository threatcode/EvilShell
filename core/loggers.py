...
class EvilshellFormatter(logging.Formatter):
...
log_path = os.path.join(core.config.base_path, 'evilshell.log')
...
file_handler.setFormatter(EvilshellFormatter())

"""Initialize the normal handler"""
stream_handler = logging.StreamHandler()
stream_handler.setFormatter(EvilshellFormatter())
